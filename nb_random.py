...
def main(borough_as_fixed_effect=True, borough_as_random_effect=True):
    """
    Main function to run the entire workflow
    
    Args:
        borough_as_fixed_effect: Whether to include borough as a fixed effect in the model
        borough_as_random_effect: Whether to include borough as a random effect in the model
    """
    ...
    # Add borough as a categorical variable if specified
    if borough_as_fixed_effect and 'borough' in data.columns:
        formula_terms.append("C(borough)")
    
    # Create formula string
    formula = "acc ~ " + " + ".join(formula_terms)
    
    # Determine random effect parameter based on user choice
    random_effect = 'borough' if borough_as_random_effect and 'borough' in data.columns else None
...
if __name__ == "__main__":
    # Configure if borough should be a fixed effect or random effect or both
    # Set both to False to exclude borough entirely
    main(borough_as_fixed_effect=False, borough_as_random_effect=True)
